<?php
    include "db.php";
    if (empty($_POST["username_form"]) || empty($_POST["password_form"])) {
        echo 'Erabiltzailea eta pasahitza eremuak bete behar dituzu.';
    }
    else {
        ...
        if(mysqli_num_rows($query)>0){
            ...
            echo 'Erabiltzailea eta pasahitza eremuak ez dira zuzenak.';
        }
?>